...
from analysis.model_zoo.esrt.model import common
import torch
...
class ESRT(nn.Module):
    def __init__(self, upscale=4, conv=common.default_conv):
        ...
        # define head module
        modules_head = [conv(1, n_feats, kernel_size)]  # 3通道改1
...
def buildESRT(upscale=4):
    return ESRT(upscale=4, conv=common.default_conv)